...
<body>
     ...
     <h1 style="text-align: center; font-size: 50px;color: #0b6ed2">今日访客</h1>
        <table border="1">
            <thead>
                <tr>
                    <th>姓名</th>
            ...
            <tbody>
                ...
                try {
                    ...
                    ResultSet rs = stmt.executeQuery("SELECT * FROM v_application WHERE DATE(starttime) = CURDATE() AND state='passed'");
                    while (rs.next()) {
